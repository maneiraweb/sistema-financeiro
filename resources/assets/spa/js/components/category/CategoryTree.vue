    ...
    <ul class="category-tree">
        <li v-for="(index, o) in categories" class="category-child">
            <div class="valign-wrapper">
                <a :data-activates="dropdownId(o)" href="#" class="category-symbol" :id="categorySymbolId(o)" :class="{'green-text': o.children.data.length > 0, 'grey-text': !o.children.data.length}">
    ...
    export default {
        ...
        methods: {
            ...
            categoryText(category) {
                return category.children.data.length > 0 ? `<strong>${category.nome}</strong>` : category.nome;
            },
